    ...
    <el-dialog title="新增" :visible.sync="isAdd" width="60%">
      <el-form label-position="right" label-width="100px" :inline="true">
        <el-form-item label="商品名:">
          <el-input v-model="installItem.productId" placeholder="请选择"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="订单名称:">
          <el-input v-model="installItem.orderId" placeholder="请选择"  style="width:250px">
        </el-input>
        </el-form-item>
        <el-form-item label="收货人:">
          <el-input v-model="installItem.receiver" placeholder="请选择"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="电话:">
          <el-input v-model="installItem.phone" placeholder="请选择"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="安装时间:" >
          <el-date-picker
            v-model="installItem.installTime"
            type="datetime"
            align="right"
        ...
        <el-form-item label="地址:">
          <el-input v-model="installItem.address" placeholder="请选择"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="内机条码:">
          <el-input v-model="installItem.innerCode" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="外机条码:">
          <el-input v-model="installItem.outterCode" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="耗材1:">
          <el-input v-model="installItem.materialOne" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="耗材2:">
          <el-input v-model="installItem.materialTwo" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="耗材3:">
          <el-input v-model="installItem.materialThree" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="耗材费用">
          <el-input v-model="installItem.materialFee" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="服务项目:">
          <el-input v-model="installItem.services" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="服务费用:">
          <el-input v-model="installItem.serviceFee" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="安装人:">
          <el-input v-model="installItem.manId" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <el-form-item label="备注:">
          <el-input v-model="installItem.remark" placeholder="请输入"  style="width:250px">
          </el-input>
        </el-form-item>
        <div style="width: 100%;border-top: 1px dotted #abbacc; ">
          <br>
          <el-form-item label="费用总额:"  >
            <el-input v-model="installItem.realPrice" style="width:250px"  disabled>
            </el-input>
          </el-form-item>
          <el-form-item label="实际应付总额:"  >
            <el-input v-model="installItem.totalPrice" style="width:250px" placeholder="请选择产品名称" >
            </el-input>
          </el-form-item>
          <el-form-item label="已付款金额:"  >
            <el-input v-model="installItem.payed" style="width:250px" placeholder="请选择产品名称" >
            </el-input>
          </el-form-item>
        </div>
